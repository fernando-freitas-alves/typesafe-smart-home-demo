...
- **Shade 4: installed, physical test deferred.** The observer could not see it. A live registry check confirmed all five share `TS0601 / _TZE284_q9xty0ad`, application version 80, hardware version 1, and a completed Zigbee interview. All five use this converter and belong to Terrace in HA. Shade 4 is expected to behave like the tested motors, but has not been physically verified; its position remains unknown until a fresh motor report. Unknown state does not block explicit commands.
