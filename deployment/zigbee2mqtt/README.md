...
- **Still unverified:** the same full physical test on shades 4 and 5. The converter is installed for all five; tests on three motors do not certify the others.
