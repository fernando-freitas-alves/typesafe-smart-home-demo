...
- **Still unverified:** the same full physical test on shade 4. The converter is installed for all five; tests on four motors do not certify the remaining motor.
