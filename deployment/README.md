...
- **Location is manual and per chat.** Choose the room or its bathroom beside the message box. If you ask “turn on the lights” without a location, the conversation asks you to choose one. Presence sensors do not identify who is there. A missing device match or unavailable device reports its actual problem instead of asking for location again.
